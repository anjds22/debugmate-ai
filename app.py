...
/* ── Select language label override ── */
.lang-label {
    font-size: 11.5px;
    font-weight: 700;
    letter-spacing: 0.08em;
...
with st.sidebar:
    ...
    <div class="tech-stack">
        <div class="tech-item"><span class="tech-dot"></span>Google Gemini 2.5 Flash</div>
...
with left:
    st.markdown("""
    <div class="card">
        <div class="card-label">⌨️ &nbsp;Your Code</div>
    </div>
    """, unsafe_allow_html=True)

    st.markdown('<div class="lang-label" style="margin-top:0.5rem;">🌐 &nbsp;Language</div>', unsafe_allow_html=True)
...
with right:
    st.markdown("""
    <div class="card">
        <div class="card-label">❌ &nbsp;Error Message</div>
    </div>
    """, unsafe_allow_html=True)

    st.markdown('<div class="lang-label" style="margin-top:0.5rem; visibility:hidden;">placeholder</div>', unsafe_allow_html=True)
    # invisible spacer to align with language dropdown
